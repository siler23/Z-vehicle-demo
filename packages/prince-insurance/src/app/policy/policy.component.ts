...
export class PolicyComponent {
  ...
  constructor(private winRef: WindowRef) {
    ...
    let webSocketURLAlerts = 'ws://myip:1880/ws/addusageevent';
    ...
    // let webSocketURL = 'ws://myip:1880/ws/location';
    ...
    let webSocketIoTURL = 'ws://myip:1880/ws/iot';
  ...
  get_vehicle()
  {
    ...
    var XMLReq = new XMLHttpRequest();
    XMLReq.open("GET", "http://myip:3000/api/Vehicle/"+vehicle_id+"?access_token=bsIvE18JpnGBmUnqaWHeogNcqHisKgdk6aFDx56iHANaWhf90OzbCmjAtrEZ3gJf");
    XMLReq.onreadystatechange = function() {
      if (XMLReq.readyState == XMLHttpRequest.DONE)
      {
  ...
  get_vehicle_alerts()
  {
    ...
    var XMLReq = new XMLHttpRequest();
    XMLReq.open("GET", "http://myip:3000/api/queries/Q2?vehicleDetails=resource%3Aorg.vda.Vehicle%23"+vehicle_id);
    XMLReq.onreadystatechange = function() {
      if (XMLReq.readyState == XMLHttpRequest.DONE)
      {
